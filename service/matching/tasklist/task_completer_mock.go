...
// isTaskStarted mocks base method.
func (m *MockTaskCompleter) isTaskStarted(task *InternalTask, workflowExecutionResponse *types.DescribeWorkflowExecutionResponse) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "isTaskStarted", task, workflowExecutionResponse)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// isTaskStarted indicates an expected call of isTaskStarted.
func (mr *MockTaskCompleterMockRecorder) isTaskStarted(task, workflowExecutionResponse interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "isTaskStarted", reflect.TypeOf((*MockTaskCompleter)(nil).isTaskStarted), task, workflowExecutionResponse)
}
